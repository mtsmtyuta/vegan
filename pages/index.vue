    ...
    <div id="main-content">
        ...
        <div class="fv-container">
          <div class="foreground">
            <div class="top">
              <div class="top-hero">
                ...
                <img
                  ...
                  height="480px"
                  width="684px"
                  src="~assets/img/kv_1.jpg"
                  alt=""
                />
              </div>
              <div
                class="flex vertical tag-line"
                data-aos="slide-down"
                data-aos-duration="1000"
              >
              ...
              >
                <div class="articles">
                  <div class="flex between">
                    ...
                    <nuxt-link class="to-archive en" to="/posts"
                      >VIEW MORE</nuxt-link
                    >
                  </div>
                    ...
                    <div class="article-inner">
                      <div class="article__items flex row-to-column">
                        <div class="article__item">
                          <nuxt-link
                            v-if="posts[0].fields.slug"
                            class="flex row-to-column"
                            :to="{
                              name: 'posts-slug',
                              params: { slug: posts[0].fields.slug }
                            }"
                          >
                            <img
                              v-if="posts[0].fields.thumbnail"
                              loading="lazy"
                              class="img-box"
                              :src="
                                `${posts[0].fields.thumbnail.fields.file.url}?fit=thumb&w=300&h=200`
                              "
                              alt=""
                            />
                            <div class="article_detail flex column">
                              <p
                                class="article__item__title bold"
                                v-if="posts[0].fields.title"
                              >
                                {{ posts[0].fields.title }}
                              </p>
                              <p
                                class="article__description"
                                v-if="posts[0].fields.description"
                              >
                                {{ posts[0].fields.description }}
                              </p>
                              <span
                                class="date"
                                v-if="posts[0].fields.publishDate"
                                >{{
                                  new Date(
                                    posts[0].fields.publishDate
                                  ).toDateString()
                                }}
                              </span>
                            </div>
                        ...
                        <div class="article__item">
                          <nuxt-link
                            v-if="posts[1].fields.slug"
                            class="flex row-to-column"
                            :to="{
                              name: 'posts-slug',
                              params: { slug: posts[1].fields.slug }
                            }"
                          >
                            <img
                              v-if="posts[1].fields.thumbnail"
                              loading="lazy"
                              class="img-box"
                              :src="
                                `${posts[1].fields.thumbnail.fields.file.url}?fit=thumb&w=300&h=200`
                              "
                              alt=""
                            />
                            <div class="article_detail flex column">
                              <p
                                class="article__item__title bold"
                                v-if="posts[1].fields.title"
                              >
                                {{ posts[1].fields.title }}
                              </p>
                              <p
                                class="article__description"
                                v-if="posts[1].fields.description"
                              >
                                {{ posts[1].fields.description }}
                              </p>
                              <span
                                class="date"
                                v-if="posts[1].fields.publishDate"
                                >{{
                                  new Date(
                                    posts[1].fields.publishDate
                                  ).toDateString()
                                }}</span
                              >
                            </div>
              ...
              <div class="sns-links flex column pc">
                <a
                  href="https://www.instagram.com/ox_vegan_jp"
                  target="_blank"
                  rel="noopener"
                  ><div class="img-box ig"></div
                ></a>
                <a
                  href="https://twitter.com/ox_vegan_jp"
                  target="_blank"
                  rel="noopener"
            ...
            <div class="txt-box bottom-ground">
              ...
              <!--            >-->
              <div
                class="img-box berries"
                data-aos="fade-left"
                data-aos-duration="2000"
              >
                <img src="~assets/img/berries.jpg" alt="berries" />
              </div>
              <h2 data-aos="fade-in" data-aos-duration="2000" class="green">
                UNLEASH YOUR POTENTIAL
              </h2>
              <div data-aos="fade-in" data-aos-duration="3000">
                <p>
                  動物性食品・加工食品の摂取を減らし、植物性食品・ホールフード中心の食事に切り替えることで、
                </p>
                <p>
                  あなたの全般的な健康だけでなく運動や知的パフォーマンスを大幅に向上させることができます。
                </p>
                <p>
                  そのことはアスリートだけでなく、人生と地球を愛する全ての人に手にしてもらいたいメリットです。
                </p>
                <p>
                  実践の為に必要なすべてのレシピやヒント、疑問への答えはここで入手してください。
                </p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div class="content-container">
          ...
          >
            <img
              src="~assets/icons/category_why_vegan_white.svg"
              alt="why_vegan"
            />
            <div class="txt-box flex column">
              ...
              <p class="category-description">
                病気のリスクを減らし、エネルギッシュでパフォーマンスの
                高い生活をおくる為には食生活を変えてみましょう。
              </p>
          ...
          >
            <img
              src="~assets/icons/category_nutrition_white.svg"
              alt="nutrition"
            />
            ...
            <div class="txt-box flex column">
              ...
              <p class="category-description">
                動物性食品から摂取できる必須栄養素の全ては、植物だけでも摂取できます。神話に騙されないために栄養について学びましょう。
              </p>
              <Button
          ...
          >
            <img
              src="~assets/icons/category_restaurants_white.svg"
              alt="restaurants"
            />
            <div class="txt-box flex column">
              ...
              <p class="category-description">
                ヴィーガン向けの飲食店は日本ではまだまだ多くはありません。
                わたしたちが見つけたオススメの店を紹介していきます。
              </p>
              <Button
                link="/posts/restaurants"
                text="食べに行こう"
                color="white"
              />
            </div>
          ...
          >
            ...
            <div class="txt-box flex column">
              ...
              <p class="category-description">
                アスリートのように生活をする中で出てくる疑問に答えたり日々の生活に役立つ情報を紹介します。
              </p>
